...
const Home = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      console.log("i ran", currentImage);
    }, 10000);
        ...
        <div className="container">
          <div className="left">
            ...
            <p>
              ...
              provident repudiandae obcaecati, voluptates, nesciunt culpa, atque
              reiciendis recusandae quidem sint tempore quia minus! Repellat
              vero distinctio doloremque explicabo, eum expedita?
            </p>
            ...
            {latestRecipes.map((recipe) => (
              <Link key={recipe.id}>
                <div className="recipe">
                  <Card imgUrl={recipe.URL} imgName={recipe.name} />
                </div>
              </Link>
            ))}
          </div>
